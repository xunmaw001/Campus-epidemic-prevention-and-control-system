    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"学号或者联系方式或者身份证号已经被使用");
        }
    }
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setBanjiTypes(Integer.valueOf(data.get(3)));   //班级 要改的
                            yonghuEntity.setXueyuanTypes(Integer.valueOf(data.get(4)));   //学院 要改的
                            yonghuEntity.setYonghuPhone(data.get(5));                    //联系方式 要改的
                            yonghuEntity.setYonghuIdNumber(data.get(6));                    //身份证号 要改的
                            yonghuEntity.setYonghuEmail(data.get(7));                    //邮箱 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("yonghuPhone")){
                                    ...
                                    yonghuPhone.add(data.get(5));//要改的
                                }else{
                                ...
                                if(seachFields.containsKey("yonghuIdNumber")){
                                    ...
                                    yonghuIdNumber.add(data.get(6));//要改的
                                }else{
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("学号或者联系方式或者身份证号已经被使用");
        yonghu.setYonghuDelete(1);
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
        return R.ok();
