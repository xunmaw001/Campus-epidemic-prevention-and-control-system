...
public class ShangbaoView extends ShangbaoEntity implements Serializable {
	...
	public ShangbaoView(ShangbaoEntity shangbaoEntity) {
		try {
			...
			* 获取： 健康状态的值
			*/
			public String getShangbaoValue() {
				return shangbaoValue;
			}
			/**
			* 设置： 健康状态的值
			*/
			public void setShangbaoValue(String shangbaoValue) {
				this.shangbaoValue = shangbaoValue;
			}
