...
import center from '@/views/center'
    ...
    import dictionaryJiaqiweizhiYesno from '@/views/modules/dictionaryJiaqiweizhiYesno/list'
    import dictionaryNews from '@/views/modules/dictionaryNews/list'
    import dictionarySex from '@/views/modules/dictionarySex/list'
    import dictionaryShangbao from '@/views/modules/dictionaryShangbao/list'
    import dictionaryXueshengqingjia from '@/views/modules/dictionaryXueshengqingjia/list'
    import dictionaryXueshengqingjiaStatus from '@/views/modules/dictionaryXueshengqingjiaStatus/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryJiaqiweizhiYesno',
        name: '审核结果',
        component: dictionaryJiaqiweizhiYesno
    }
    ,{
        path: '/dictionaryNews',
        name: '公告类型',
    ...
    ,{
        path: '/dictionaryShangbao',
        name: '健康状态',
        component: dictionaryShangbao
    }
    ,{
    ...
    ,{
        path: '/dictionaryXueshengqingjiaStatus',
        name: '请假状态',
        component: dictionaryXueshengqingjiaStatus
    }
    ,{
