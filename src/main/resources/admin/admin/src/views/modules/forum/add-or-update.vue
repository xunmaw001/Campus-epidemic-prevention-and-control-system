    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="聊天室标题" prop="forumName">
                        <el-input v-model="ruleForm.forumName"
                                  placeholder="聊天室标题" clearable  :readonly="ro.forumName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="聊天室标题" prop="forumName">
                            <el-input v-model="ruleForm.forumName"
                                      placeholder="聊天室标题" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   forumName: [
                              { required: true, message: '聊天室标题不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                   ...
                   forumStateTypes: [
                              { required: true, message: '聊天室状态不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
