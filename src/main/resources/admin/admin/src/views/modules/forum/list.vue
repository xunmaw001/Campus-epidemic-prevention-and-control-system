<template>
    <div class="main-content">
        <el-dialog title="聊天室回复详情" :visible.sync="forumReplyDialogVisible">
            <el-dialog
                    width="30%"
            ...
            <div class="demo-input-suffix">
                <span style="width: 20%">聊天室标题：</span><el-input v-model="forumTitle" :disabled="true" placeholder="聊天室标题" style="width: 80%"></el-input>
            </div>
            <div class="demo-input-suffix">
                <span style="width: 20%">聊天室内容：</span><el-input v-model="forumContent" :disabled="true" placeholder="聊天室内容" style="width: 80%" type="textarea"></el-input>
            </div>
            <el-table :data="forumData" height="250">
                ...
                <el-table-column property="insertTime" label="回复时间"></el-table-column>
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回复详情</el-button>
            ...
            <div class="demo-input-suffix">
                <span style="width: 20%">回复内容：</span>
                <el-input v-model="forumReplyContent" placeholder="回复内容" style="width:80%" type="textarea"></el-input>
            </div>

            <div slot="footer" class="dialog-footer">
                <el-button @click="forumReplyDialogVisible = false">取 消</el-button>
                <el-button type="primary" @click="forumReply">回 复</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '聊天室标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.forumName" placeholder="聊天室标题" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanyiqingfangkong/upload/forumMuBan.xls"
                        >批量导入聊天室数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('forum','查看')" type="primary" icon="el-icon-edit" size="mini" @click="openReplyForum(scope.row.id,scope.row.forumName,scope.row.forumContent)">查看聊天室回复</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            forumReplyDialogVisible : false,//聊天室回复模态框
            forumReplyInfoDialogVisible : false,//聊天室回复详情模态框
            superIds : "",//聊天室id
            forumTitle : "",//聊天室标题
            forumContent : "",//聊天室内容
            forumReplyContent : "",//聊天室回复内容
            forumReplyInfoContent : "",//聊天室某个回复详情 全
            forumData : [],//聊天室回复数据集合
        ...
        methods: {
            ...
            // 当前聊天室相关 end
                _this.forumReplyContent = "";//聊天室回复
                _this.forumReplyDialogVisible = true;//聊天室回复模态框
                _this.forumReplyInfoDialogVisible = false;//聊天室回复详情模态框
            ...
            seeForumContent(forumContent) {
                let _this = this;
                _this.forumReplyInfoContent = forumContent;//聊天室某个回复详情 全
                _this.forumReplyInfoDialogVisible = true;//聊天室回复详情模态框
            },
            // 删除数据
            deleteForumData(id){
                let _this = this;
