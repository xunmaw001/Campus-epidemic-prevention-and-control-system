    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="健康状态" prop="shangbaoTypes">
                        <el-select v-model="ruleForm.shangbaoTypes" :disabled="ro.shangbaoTypes" placeholder="请选择健康状态">
                            <el-option
                                v-for="(item,index) in shangbaoTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="健康状态" prop="shangbaoValue">
                        <el-input v-model="ruleForm.shangbaoValue"
                            placeholder="健康状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="shangbaoTiwen">
                       <el-input v-model="ruleForm.shangbaoTiwen"
                                 placeholder="体温" clearable  :readonly="ro.shangbaoTiwen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="体温" prop="shangbaoTiwen">
                           <el-input v-model="ruleForm.shangbaoTiwen"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="shangbaoText">
                        <el-input type="textarea"  :readonly="ro.shangbaoText" v-model="ruleForm.shangbaoText" placeholder="详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangbaoText" label="详情" prop="shangbaoText">
                            <span v-html="ruleForm.shangbaoText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                shangbaoTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                              { required: true, message: '上报学生不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangbao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangbaoTypesOptions = data.data.list;
                    }
                });
