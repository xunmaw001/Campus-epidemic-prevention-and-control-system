    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假原因" prop="xueshengqingjiaName">
                       <el-input v-model="ruleForm.xueshengqingjiaName"
                                 placeholder="请假原因" clearable  :readonly="ro.xueshengqingjiaName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="请假原因" prop="xueshengqingjiaName">
                           <el-input v-model="ruleForm.xueshengqingjiaName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="xueshengqingjiaText">
                        <el-input type="textarea"  :readonly="ro.xueshengqingjiaText" v-model="ruleForm.xueshengqingjiaText" placeholder="详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengqingjiaText" label="详情" prop="xueshengqingjiaText">
                            <span v-html="ruleForm.xueshengqingjiaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="请假类型" prop="xueshengqingjiaTypes">
                        <el-select v-model="ruleForm.xueshengqingjiaTypes" :disabled="ro.xueshengqingjiaTypes" placeholder="请选择请假类型">
                            <el-option
                                v-for="(item,index) in xueshengqingjiaTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="请假类型" prop="xueshengqingjiaValue">
                        <el-input v-model="ruleForm.xueshengqingjiaValue"
                            placeholder="请假类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="请假时间" prop="xueshengqingjiaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xueshengqingjiaTime"
                                type="datetime"
                                placeholder="请假时间"
                                :disabled="ro.xueshengqingjiaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengqingjiaTime" label="请假时间" prop="xueshengqingjiaTime">
                            <span v-html="ruleForm.xueshengqingjiaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假天数" prop="xueshengqingjiaNumber">
                       <el-input v-model="ruleForm.xueshengqingjiaNumber"
                                 placeholder="请假天数" clearable  :readonly="ro.xueshengqingjiaNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="请假天数" prop="xueshengqingjiaNumber">
                           <el-input v-model="ruleForm.xueshengqingjiaNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <div v-if="type=='info'">
                        <el-form-item class="input" label="请假状态" prop="xueshengqingjiaStatusValue">
                        <el-input v-model="ruleForm.xueshengqingjiaStatusValue"
                            placeholder="请假状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    xueshengqingjiaName: '',
                    xueshengqingjiaText: '',
                    xueshengqingjiaTypes: '',
                    xueshengqingjiaTime: '',
                    xueshengqingjiaNumber: '',
                    yonghuId: '',
                    xueshengqingjiaYesnoTypes: '1',
                    xueshengqingjiaYesnoText: '',
                    xueshengqingjiaStatusTypes: '',
                    insertTime: '',
                },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengqingjia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengqingjiaTypesOptions = data.data.list;
                    }
                });
                this.$http({
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengqingjia_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengqingjiaStatusTypesOptions = data.data.list;
                    }
                });
